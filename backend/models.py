...
class Questions(Base):
    ...
    content = Column(String(255), not_null=True)
    description = Column(String(255), not_null=True)
...
class Answers(Base):
    ...
    content = Column(String(255), not_null=True)
    timestamp = Column(DateTime, not_null=True)
...
class Scores(Base):
    ...
    score = Column(Float, not_null=True)
    rank = Column(Integer, not_null=True)
...
class TotalScores(Base):
    ...
    user_id = Column(Integer, ForeignKey("users.user_id"), primary_key=True)
    total_score = Column(Float, not_null=True)
    rank = Column(Integer, not_null=True)
